...
const MobileNav = ({ navClose, showNav, handleshowModel }: Prop) => {
	...
	return (
		<div>
			...
			{/* Menu */}
			<div
				className={`fixed ${navOpen} bg-[#E0EAFC] z-[1054] h-full w-[80%] md:w-[60%] flex flex-col justify-center items-center transform transition duration-500 delay-30 space-y-6`}
			>
				{/* menu items */}
				{navLinks.map((link) => {
					return (
